...
public interface PrestamoApi {
    ...
    @RequestMapping(
            ...
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<List<Prestamo>> listarPrestamosPorUsuario(@RequestParam Integer idUsuario) throws BadRequestException;
    
    @RequestMapping(
            value = "/libro",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<List<Prestamo>> listarPrestamosPorLibro(@RequestParam Integer idLibro) throws BadRequestException;
    
    @RequestMapping(
            value = "/vencidos",
            produces = {"application/json"},
            method = RequestMethod.GET)
    ResponseEntity<List<Prestamo>> listarPrestamosVencidos() throws BadRequestException;
}
